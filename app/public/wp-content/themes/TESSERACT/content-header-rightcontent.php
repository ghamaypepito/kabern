...
$is_headright_content = (get_theme_mod('tesseract_header_right_content') ) ? get_theme_mod('tesseract_header_right_content') : 'nothing';

$headright_content = ( $is_headright_content!='nothing' ) ? get_theme_mod('tesseract_header_right_content') : 'no-right-content';

$headright_content_default_button = get_theme_mod('tesseract_header_content_if_button');

$wc_headercart = ( get_theme_mod('tesseract_woocommerce_headercart')  ) ? get_theme_mod('tesseract_woocommerce_headercart') : 'disable';
...
<?php endif; ?>   
    ...
    <?php if ( is_plugin_active('woocommerce/woocommerce.php') && $wc_headercart=='enable' ) tesseract_wc_output_cart(); ?> 
