	               		...
	               		<div class="animated  fadeInRight">
	               			<?php for($i=1;$i<=12;$i++){ ?>
		               			<div class="content-block Sample #<?php echo $i; ?>" style="background-image: url('https://s3.amazonaws.com/tesseracttheme/Free-Theme-Designer-Screenshots/design/img-<?php echo $i; ?>.jpg')">
									...
									<a href="http://tesseracttheme.com/designer/" target="_blank"><div class="content-block-lock animated fadeIn"><h5><i class="fa fa-lock" aria-hidden="true"></i> Activate This</h5></div></a>
								</div>
							<?php } ?>
	               		</div>
	               	</div>
