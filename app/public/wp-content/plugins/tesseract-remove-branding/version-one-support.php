 ...
 */
if( !function_exists( 'trb_version_one_check' )){
 ...
 */
if( !function_exists( 'trb_start_footer_buffer' )){
 ...
 */
if( !function_exists( 'trb_scan_footer_buffer_for_branding' )){
...
if( !function_exists( 'trb_add_version_one_body_class' )){
